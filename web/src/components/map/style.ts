...
const mapFontsVersion = '1.0.0';

export const style: MapStyle = {
    id: 'kruger-companion',
    version: 8,
    name: 'Kruger Companion',
    metadata: {
    ...
    sources: {
        openmaptiles: {
            type: 'vector',
            url: 'https://tiles.krugercompanion.com/kruger'
        }
    },
    sprite: 'https://maputnik.github.io/osm-liberty/sprites/osm-liberty',
    glyphs: `${window.location.origin}/map/fonts/${mapFontsVersion}/{fontstack}/{range}.pbf`,
    layers: [
        {
            id: 'background',
            type: 'background',
        ...
        },
        {
            ...
            filter: [
                'all',
                ['!in', 'brunnel', 'bridge', 'tunnel'],
                ['in', 'class', 'service', 'track', 'minor', 'secondary', 'tertiary'],
                ['has', 'ref'],
                ['!=', 'surface', 'paved']
            ],
        ...
        },
        {
            ...
            layout: { 'line-cap': 'round', 'line-join': 'round' },
            paint: { 'line-color': 'rgba(0, 0, 0, 1)', 'line-width': 6 }
        },
        {
            id: 'road_unpaved',
            type: 'line',
            ...
            layout: { 'line-cap': 'round', 'line-join': 'round' },
            paint: { 'line-color': 'rgba(255, 238, 0, 1)', 'line-width': 2 }
        },
        {
            id: 'road_paved',
            type: 'line',
