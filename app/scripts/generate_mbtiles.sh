...
docker run -v "$(pwd)/tmp/mbtiles":/osm-data yagajs/osmosis osmosis -v --read-pbf /osm-data/south-africa-latest.osm.pbf --bounding-box left=30.753648 right=32.692252 top=-22.16947 bottom=-25.605811 completeWays=yes completeRelations=yes cascadingRelations=yes --write-pbf /osm-data/kruger-park.osm.pbf
